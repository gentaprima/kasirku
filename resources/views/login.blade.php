...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('login/css/main-new.css')}}?v={{ time() }}">
	<link rel="stylesheet" href="{{ asset('dashboard/new-style-2.css') }}?v={{ time() }}">
	<!--===============================================================================================-->
</head>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="{{asset('/warkop.png')}}" style="position: relative;bottom: 60px;" alt="IMG" class="size-logo">
				</div>
